...
export class MinistryRendererRoute {
    ...
    //     { key: 'morningtea1', caption: '茶點', optionGetter: 'morningteaCandidates' },
    //     { key: 'morningtea2', caption: '茶點', optionGetter: 'morningteaCandidates' },
    ...
    constructor() {
        ...
        this.router.get('/', (req, res, next) => {
            Promise.all([
                ...
                let text = snapshots[2].val();
                this.ministryRoles = text.chinese['ministry-roles'];
